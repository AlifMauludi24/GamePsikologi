 ...
 * @author AlifM
 */
public class Hasil6 extends javax.swing.JFrame {

    /**
     * Creates new form Hasil6
     */
    public Hasil6() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Hasil6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
